...
const cargarImagen = (id, nombre, ruta, descripcion) => {
  ...
  if (galeria$4.querySelectorAll('.galeria__carousel-slide').length > 0) {
    //eliminamos la clase active ce cualquier slide
    galeria$4
...
contenedorCategorias.addEventListener('click', (e) => {
    ...
    if (e.target.closest('a')) {
        ...
        galeria$3.dataset.categoria = categoriaActiva; //agregamos la categoria activa para el carousel
...
const cerrarGaleria = () => {
  galeria$2.classList.remove('galeria--active'); //remover la galeria activa
